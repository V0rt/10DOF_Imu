...
{   
          ...
          norm = 1.0 / sqrt(sq(sen_data.magnetom_x)+sq(sen_data.magnetom_y)+sq(sen_data.magnetom_z)); 
          
          //The magnetic field inclination in Malmö is 70 degrees.
          
          ydot = -norm*sen_data.magnetom_y*cos(ToRad(84.0)) - norm*sen_data.magnetom_y*norm*sen_data.magnetom_z*sin(ToRad(84.0));
          zdot = norm*sen_data.magnetom_y*sin(ToRad(84.0)) + norm*sen_data.magnetom_z*cos(ToRad(84.0));
